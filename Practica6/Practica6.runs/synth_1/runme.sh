...
HD_PWD='D:/Pogramas/Practica6/Practica6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSMulticiclo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPSMulticiclo.tcl
