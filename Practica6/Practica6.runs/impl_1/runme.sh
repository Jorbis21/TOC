...
HD_PWD='D:/Pogramas/Practica6/Practica6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSMulticiclo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPSMulticiclo.tcl -notrace
