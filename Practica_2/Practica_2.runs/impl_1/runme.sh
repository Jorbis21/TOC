...
HD_PWD='D:/Pogramas/Practica_2/Practica_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source code.tcl -notrace
