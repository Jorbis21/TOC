...
HD_PWD='D:/Pogramas/Practica_2/Practica_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source code.tcl
