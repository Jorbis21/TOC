...
HD_PWD='D:/Pogramas/practica_1/practica_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log registro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source registro.tcl -notrace
