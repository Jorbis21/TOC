...
HD_PWD='D:/Pogramas/practica_1/practica_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log registro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source registro.tcl
