...
HD_PWD='D:/Pogramas/practica4/practica4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult4x4.tcl
