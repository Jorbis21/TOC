...
HD_PWD='D:/Pogramas/practica_3/practica_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_adders.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult_adders.tcl
