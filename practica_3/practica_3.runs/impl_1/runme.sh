...
HD_PWD='D:/Pogramas/practica_3/practica_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_adders.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mult_adders.tcl -notrace
