...
## Switches
set_property PACKAGE_PIN V17 [get_ports {din_t[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din_t[0]}]
set_property PACKAGE_PIN V16 [get_ports {din_t[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din_t[1]}]
set_property PACKAGE_PIN W16 [get_ports {din_t[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din_t[2]}]
set_property PACKAGE_PIN W17 [get_ports {din_t[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din_t[3]}]
set_property PACKAGE_PIN W15 [get_ports {wea_t[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {wea_t[0]}]
...
set_property PACKAGE_PIN T17 [get_ports boton_inicio]						
	set_property IOSTANDARD LVCMOS33 [get_ports boton_inicio]
set_property PACKAGE_PIN U17 [get_ports boton_fin]						
	set_property IOSTANDARD LVCMOS33 [get_ports boton_fin]
