...
HD_PWD='D:/Pogramas/practica5/practica5.runs/memoria_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoria_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoria_bram.tcl
