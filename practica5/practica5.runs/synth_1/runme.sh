...
HD_PWD='D:/Pogramas/practica5/practica5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_tragaperras.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sintesis_tragaperras.tcl
