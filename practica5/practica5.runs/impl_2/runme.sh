...
HD_PWD='D:/Pogramas/practica5/practica5.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_tragaperras.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sintesis_tragaperras.tcl -notrace
